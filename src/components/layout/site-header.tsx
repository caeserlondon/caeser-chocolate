	...
	return (
		<header className='sticky top-0 z-40 overflow-visible border-b border-[#8f6935]/40 bg-[#1b0805]/85 backdrop-blur-sm'>
			<div className='relative mx-auto flex h-16 max-w-[1400px] items-center justify-between px-6 lg:px-14'>
				<a
					href='#top'
					className='absolute left-6 top-1/2 z-10 flex -translate-y-1/2 items-center gap-2.5 lg:left-14'
				>
					<Image
						src='/logo.avif'
				...
				<div className='ml-auto flex items-center gap-8'>
					...
					<a
						href='#collection'
						className='rounded-md border border-[#c5984a] bg-[linear-gradient(180deg,rgba(233,191,108,0.08),rgba(185,130,49,0.02))] px-5 py-2 text-sm font-medium tracking-[0.02em] text-[#f0cd84] transition hover:border-[#efc46c] hover:bg-[#2c140c]'
					>
						Shop Now
					</a>
				</div>
